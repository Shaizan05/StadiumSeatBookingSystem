    ...
    <div class="container">
        ...
        <form id="addF">
            ...
            <div class="mb-3" >
                ...
                <div style="display: flex; align-items: center;">
                    <label for="eventdatefrom" class="form-label" >From :-</label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="date" class="form-control w-25" id="eventdatefrom" title="you can book studiam for 7 day or above" value="<%= ed.getString("startDate")%>">&nbsp;&nbsp;&nbsp;&nbsp;
                    <label for="eventdateto" class="form-label">To :-</label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="date" class="form-control w-25" id="eventdateto" title="you can book studiam for 7 day or above" onchange="totalAmount()" value="<%= ed.getString("endDate")%>">&nbsp;&nbsp;&nbsp;&nbsp;
                </div> 
            </div>
            <div style="display: flex; align-items: center;">
                <div classs="mb-3">
